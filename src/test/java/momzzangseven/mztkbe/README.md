...
AI Agent 및 팀원용 테스트 코드 작성 가이드.

→ AI Agent용 테스트 규칙: `src/test/AGENTS.md`
→ E2E 상세 규칙: `src/test/java/momzzangseven/mztkbe/integration/e2e/AGENTS.md`
...
로컬 E2E DB 셋업/재생성 절차는 팀 내부 공유 문서를 따릅니다. 문서나 테스트 fixture에 실제 secret, 실제 지갑 private key, 운영 credential을 남기지 않습니다.

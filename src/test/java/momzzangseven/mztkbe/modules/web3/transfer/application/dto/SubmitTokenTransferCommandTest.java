...
class SubmitTokenTransferCommandTest {
  ...
  void validate_nullUserId_throwsException() {
    SubmitTokenTransferCommand command =
        new SubmitTokenTransferCommand(null, "prepare-1", "auth-sig", "exec-sig");
  ...
  @Test
  @DisplayName("validate rejects null prepareId")
  void validate_nullPrepareId_throwsException() {
    SubmitTokenTransferCommand command =
        new SubmitTokenTransferCommand(1L, null, "auth-sig", "exec-sig");
  ...
  @Test
  @DisplayName("validate rejects null authorization signature")
  void validate_nullAuthorizationSignature_throwsException() {
    SubmitTokenTransferCommand command =
        new SubmitTokenTransferCommand(1L, "prepare-1", null, "exec-sig");
  ...
  @Test
  @DisplayName("validate rejects null execution signature")
  void validate_nullExecutionSignature_throwsException() {
    SubmitTokenTransferCommand command =
        new SubmitTokenTransferCommand(1L, "prepare-1", "auth-sig", null);

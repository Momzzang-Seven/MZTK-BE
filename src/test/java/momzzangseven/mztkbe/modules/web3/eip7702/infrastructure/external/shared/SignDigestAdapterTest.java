...
@DisplayName("SignDigestAdapter (eip7702 → shared bridging)")
class SignDigestAdapterTest {
  ...
  @Test
  @DisplayName("@Component 빈 이름이 eip7702SignDigestAdapter 로 네임스페이싱되어 있다")
  void componentBeanName_isNamespacedToEip7702Module() {
    Component component = SignDigestAdapter.class.getAnnotation(Component.class);

    assertThat(component).isNotNull();
    assertThat(component.value()).isEqualTo("eip7702SignDigestAdapter");
  }
}

...
class LoginServiceTest {
  ...
  class LoginSuccessTest {
    ...
    void execute_SocialLogin_NewUser_Success() {
      AccountUserSnapshot snapshot = createFakeSnapshot();
      LoginCommand command =
          new LoginCommand(AuthProvider.KAKAO, null, null, "kakao-auth-code", null, null, null);
  ...
  class LoginFailureTest {
    ...
    void execute_NullProvider_ThrowsException() {
      LoginCommand command = new LoginCommand(null, "email@test.com", "pw", null, null, null, null);
    ...
    void execute_UnsupportedProvider_ThrowsException() {
      LoginCommand command =
          new LoginCommand(AuthProvider.KAKAO, null, null, "auth-code", null, null, null);
    ...
    void execute_StrategyThrowsException_PropagatesException() {
      LoginCommand command =
          new LoginCommand(
              AuthProvider.LOCAL, "email@test.com", "wrong-pw", null, null, null, null);

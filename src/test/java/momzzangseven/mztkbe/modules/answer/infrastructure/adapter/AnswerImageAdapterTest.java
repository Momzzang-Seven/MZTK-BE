  ...
  void loadImagesByAnswerIdsBuildsPublicUrls() {
    ...
    when(getImagesByReferencesUseCase.execute(
            new GetImagesByReferencesCommand(
                ImageReferenceType.COMMUNITY_ANSWER, List.of(31L, 32L))))
        .thenReturn(
            GetImagesByReferencesResult.of(
                Map.of(
                    31L,
                    List.of(
                        new ImageItem(100L, ImageStatus.COMPLETED, "/answers/first.webp"),
                        new ImageItem(101L, ImageStatus.PENDING, null)),
                    32L,
                    List.of(new ImageItem(200L, ImageStatus.FAILED, null)))));

    Map<Long, AnswerImageResult> result =
        answerImageAdapter.loadImagesByAnswerIds(List.of(31L, 32L));
    ...
    assertThat(result)
        ...
        .containsEntry(32L, new AnswerImageResult(List.of(new AnswerImageSlot(200L, null))));
  }

...
class ExternalDisconnectRetryServiceTest {
  ...
  void setUp() {
    ...
    props.setInitialBackoff(1_000L);
    props.setMaxBackoff(5_000L);
    service = new ExternalDisconnectRetryService(externalDisconnectTaskPort, props, executor);
  }

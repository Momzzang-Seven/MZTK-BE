...
class ReservationStatusTest {
    ...
    void canTransitionTo_FromPending() {
        ...
        assertThat(ReservationStatus.PENDING.canTransitionTo(ReservationStatus.USER_CANCELLED)).isTrue();
        assertThat(ReservationStatus.PENDING.canTransitionTo(ReservationStatus.REJECTED)).isTrue();
        assertThat(ReservationStatus.PENDING.canTransitionTo(ReservationStatus.TIMEOUT_CANCELLED)).isTrue();
    ...
    void canTransitionTo_FromApproved() {
        ...
        assertThat(ReservationStatus.APPROVED.canTransitionTo(ReservationStatus.USER_CANCELLED)).isFalse();
        assertThat(ReservationStatus.APPROVED.canTransitionTo(ReservationStatus.REJECTED)).isFalse();
        assertThat(ReservationStatus.APPROVED.canTransitionTo(ReservationStatus.TIMEOUT_CANCELLED)).isFalse();
    }

...
DROP TABLE IF EXISTS _mztk_v084_normalized_nonce_state;

CREATE TEMP TABLE _mztk_v084_normalized_nonce_state AS
SELECT
...
FROM _mztk_v084_normalized_nonce_state;

DROP TABLE _mztk_v084_normalized_nonce_state;

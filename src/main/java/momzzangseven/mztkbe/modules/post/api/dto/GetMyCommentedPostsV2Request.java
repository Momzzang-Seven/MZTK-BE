...
public record GetMyCommentedPostsV2Request(PostType type, String cursor, Integer size) {

  public GetMyCommentedPostsCursorCommand toCommand(Long requesterId) {
    return new GetMyCommentedPostsCursorCommand(requesterId, type, cursor, size);
  }
}

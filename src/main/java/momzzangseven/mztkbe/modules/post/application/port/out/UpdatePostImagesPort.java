...
/**
 * Output port for delegating image updates to the image module.
 * Implemented by the infrastructure adapter that bridges the post and image modules.
 */
public interface UpdatePostImagesPort {
    /**
     * Updates images associated with a post. Called during post modification to synchronize the
     * image set (unlink removed images, reorder remaining ones).
     *

...
public class LoginResponseDTO {
  ...
  public static LoginResponseDTO from(LoginResult result) {
    return LoginResponseDTO.builder()
        ...
        .userInfo(UserInfo.from(result.userSnapshot(), result.walletAddress()))
        .build();
  }
  ...
  public static class UserInfo {
    ...
    /**
     * Map the AccountUserSnapshot to API payload.
     *
     * @param snapshot account user snapshot
     * @param walletAddress active wallet address from user_wallets, or null
     * @return nested user info DTO
     */
    public static UserInfo from(AccountUserSnapshot snapshot, String walletAddress) {

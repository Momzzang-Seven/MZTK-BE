...
public record UpdateClassRequestDTO(
    ...
    @NotNull @Positive int priceAmount,
    @NotNull @Min(1) @Max(1440) int durationMinutes,
    @Size(max = 3) List<@Size(max = 30) String> tags,
    @Size(max = 10) List<@Size(max = 100) String> features,

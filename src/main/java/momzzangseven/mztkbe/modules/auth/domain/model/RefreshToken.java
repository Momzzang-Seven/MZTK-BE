 ...
 *
 * <p>Responsibilities (Information Expert Pattern):
 * - Validate token expiration
 * - Check if token is revoked
 * - Track token usage
 * - Enforce business rules for token lifecycle
 *
 * <p>Business Rules:
 * - Token can only be used if not expired and not revoked
 * - Token can be revoked at any time
 * - Token usage is tracked for security audit
 */
@Slf4j
@Getter
@Builder
public class RefreshToken {
     ...
     *
     * <p>Business Rule: Token is valid only if:
     * 1. Not expired
     * 2. Not revoked
     *

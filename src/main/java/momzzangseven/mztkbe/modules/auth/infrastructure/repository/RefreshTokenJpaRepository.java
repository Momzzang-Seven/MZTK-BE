 ...
 * - Used by RefreshTokenPersistenceAdapter (not directly by application layer)
 *
 * <p>Naming Convention:
 * - findBy...: Query methods
 * - deleteBy...: Delete methods
 * - existsBy...: Boolean check methods
 */
@Repository
public interface RefreshTokenJpaRepository extends JpaRepository<RefreshTokenEntity, Long> {
     ...
     *
     * <p>Most common query for token validation.
     *
     ...
     * Use findAllByUserId() if you need all tokens.
     *
     ...
     * - Security: Detect multiple active sessions
     *
     * @param userId User's unique identifier

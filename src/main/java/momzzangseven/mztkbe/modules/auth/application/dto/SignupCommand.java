 ...
 *
 * Application Layer DTO that encapsulates signup request data.
 * This separates API layer concerns from business logic.
 */
public record SignupCommand(
     ...
     *
     * Additional business validations beyond Jakarta Validation.
     */

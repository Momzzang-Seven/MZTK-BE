 ...
 *
 * <p>Each role maps to a single canonical wallet alias; downstream lookup ports
 * ({@code LoadRewardTreasuryAliasPort}, {@code LoadSponsorTreasuryAliasPort}) resolve a request to
 * the wallet bound to the alias produced by {@link #toAlias()}.
 */

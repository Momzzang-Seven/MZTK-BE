...
/**
 * Published once per wallet alias after its cohort has transitioned to {@code ARCHIVED} and the
 ...
 * ScheduleKeyDeletion} side effect fires once per cohort.
 */
public record AliasArchivedAuditEvent(

...
public class MarketplacePayloadSerializer {
  ...
  public String serialize(Object payload) {
    try {
      ...
      throw new IllegalStateException("failed to serialize marketplace execution payload", e);
    }
  }
  ...
  public String hashHex(Object payload) {
    try {
      ...
      throw new IllegalStateException("failed to hash marketplace execution payload", e);
    }
  }
}

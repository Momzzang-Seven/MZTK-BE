...
/**
 * Cross-module entry point for signing an EIP-1559 (Type-2) transaction with an externally-held key
 * (AWS KMS).
 *
 * <p>Sibling web3 sub-modules (transaction, execution, ...) depend on this in-port via the {@code
 * web3/shared/application/port/in/} package — implementations and codec adapters under {@code
 * web3/shared/infrastructure/adapter/} stay private to this module per ARCHITECTURE.md's
 * cross-module rules.
 */

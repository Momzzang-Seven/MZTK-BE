...
/**
 * Transaction-side bridging port for the pre-sign treasury verification gate. Implemented by an
 * adapter under {@code infrastructure/external/treasury/} that delegates to the treasury module's
 * {@code VerifyTreasuryWalletForSignUseCase}; transaction-layer callers never import treasury types
 * directly.
 */

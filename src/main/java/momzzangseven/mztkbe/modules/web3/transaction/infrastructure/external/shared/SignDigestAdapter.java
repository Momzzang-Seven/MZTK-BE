...
/**
 * Bridging adapter that fulfils the transaction-local {@link SignDigestPort} by delegating to the
 * {@code shared} module's {@link SignDigestUseCase}. Keeps the transaction application layer free
 * of cross-module imports per ARCHITECTURE.md.
 */
@Component("transactionSignDigestAdapter")

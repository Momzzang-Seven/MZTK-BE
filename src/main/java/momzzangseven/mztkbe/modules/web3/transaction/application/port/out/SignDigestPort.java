...
/**
 * Transaction-module own out-port for digest-based ECDSA signing.
 *
 * <p>Per ARCHITECTURE.md, modules never depend on another module's in-port directly. The bridging
 * adapter {@code web3/transaction/infrastructure/external/shared/SignDigestAdapter} translates this
 * port to the shared {@code SignDigestUseCase}, so the application layer of {@code
 * web3/transaction} remains free of cross-module imports.
 */

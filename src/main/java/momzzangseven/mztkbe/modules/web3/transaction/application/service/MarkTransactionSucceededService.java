    ...
    recordTransactionAuditPort.record(
        new RecordTransactionAuditPort.AuditCommand(
            ...
            AuditDetailBuilder.create()
                .put("operatorId", command.operatorId())
                .put("fromStatus", snapshot.status())
                .put("toStatus", Web3TxStatus.SUCCEEDED)
                .put("reason", command.reason())
                .put("evidence", command.evidence())
                .put("explorerUrl", command.explorerUrl())
                .put("txHash", command.txHash())
                .put("receiptFound", receipt.found())
                .put("receiptSuccess", receipt.success())
                .put("receiptFailureReason", receipt.failureReason())
                .build()));

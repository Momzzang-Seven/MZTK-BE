...
public class WalletApprovalPayloadSerializer {
  ...
  public String serialize(Object payload) {
    try {
      ...
      throw new IllegalStateException("failed to serialize wallet approval payload", e);
    }
  }
  ...
  public String hashHex(Object payload) {
    try {
      ...
      throw new IllegalStateException("failed to hash wallet approval payload", e);
    }
  }
}

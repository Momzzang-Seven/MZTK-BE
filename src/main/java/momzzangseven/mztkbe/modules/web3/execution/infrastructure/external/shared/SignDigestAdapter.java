...
/**
 * Bridging adapter that fulfils the execution-local {@link SignDigestPort} by delegating to the
 * {@code shared} module's {@link SignDigestUseCase}. Keeps the execution application layer free of
 * cross-module imports per ARCHITECTURE.md.
 */
@Component("executionSignDigestAdapter")

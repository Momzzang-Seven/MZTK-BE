 ...
 *
 * Each error code has:
 * - code: Unique identifier for the error (e.g., "AUTH_001")
 * - message: Default error message
 * - httpStatus: HTTP status code to return
 *
 * Naming Convention:
 * - AUTH_xxx: Authentication/Authorization errors
 * - SIGNUP_xxx: User registration errors
 * - WALLET_xxx: Wallet-related errors
 * - CHALLENGE_xxx: Challenge verification errors
 * - VALIDATION_xxx: Input validation errors
 * - INTERNAL_xxx: System errors
 */
@Getter
...
public enum ErrorCode {
    ...
    WALLET_NOT_CONNECTED(
            "WALLET_003",
            "No wallet connected to this account",
            HttpStatus.BAD_REQUEST  // 400
    ),

...
description: >
  ...
  - Any situation where an implementation blueprint is needed after a design doc is complete and before coding starts
  - Implementation planning for a Jira ticket
---

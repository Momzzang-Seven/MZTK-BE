...
description: >
  ...
  - "설계해줘", "기능 설계", "디자인 문서 만들어줘", "설계 문서 작성", "설계서 만들어줘" 등의 요청
  - "design document", "feature design", "feature plan", "API 설계" 등의 요청
  - 새로운 기능 구현 전 청사진이 필요한 모든 상황
  - Jira 티켓 기반으로 기능을 설계해야 할 때
  - 기존 모듈 확장 또는 신규 모듈 추가 설계가 필요할 때
---
